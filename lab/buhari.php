						...
						$current=$row['amount'];
                                       ...
                                       // $text=$current;
                                        if($current >= $_POST['amount'])
                                            {
                                             $sql="Insert into orders(canteen,rollno,items,name,address,amount,time) values('Buhari', '".$_SESSION['user']."','".$item."','".mysql_real_escape_string($_POST['name'])."','". $_POST['add']."','".mysql_real_escape_string($_POST['amount'])."',NOW())";
                                            ...
                                            $s="update canteen set sales = sales + '".$_POST['amount']."' where name='Buhari'";
...
<div id="center">
	<div>
                        ...
                        <div align="center"><img src="images/menu3.jpg" width="1250px" height="230px" /><br/>
                        </div>
</div>
...
<tr> <td colspan="2" align="center"> <div align="center" style="font-weight: bold; font-family: Verdana, Arial, Helvetica, sans-serif; color: #0000CC; font-style: italic">  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color: #CC0099; font-size: 28px">BUHARI </span></div></td>
</tr>
<tr align="center">
...
<div id="left">
	<div>
                        ...
                        <img src="images/11.jpg" width="250px" height="200px" /><br/>
                        <img src="images/nitt.jpg" width="250px" height="200px" />
