						...
						$current=$row['amount'];
                                       ...
                                       // $text=$current;
                                        if($current >= $_POST['amount'])
                                            {
                                             $sql="Insert into orders(canteen,rollno,items,name,address,amount,time) values('Meenakshi', '".$_SESSION['user']."','".$item."','".mysql_real_escape_string($_POST['name'])."','". $_POST['add']."','".mysql_real_escape_string($_POST['amount'])."',NOW())";
                                            ...
                                            $s="update canteen set sales = sales + '".$_POST['amount']."' where name='Meenakshi'";
...
<tr> <td colspan="2" align="center"> <div align="center" style="font-weight: bold; font-family: Verdana, Arial, Helvetica, sans-serif; color: #0000CC; font-style: italic">  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-size: 28px">MEENAKSHI BHAWAN </span></div></td>
</tr>
<tr align="center">
